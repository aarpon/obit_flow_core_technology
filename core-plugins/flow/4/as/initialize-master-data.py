...
# SONY_EXPERIMENT
samp_type_SONY_EXPERIMENT = tr.getOrCreateNewSampleType('SONY_EXPERIMENT')
samp_type_SONY_EXPERIMENT.setDescription('Experiments from the SONY Cell Sorters.')
samp_type_SONY_EXPERIMENT.setListable(True)
samp_type_SONY_EXPERIMENT.setShowContainer(False)
samp_type_SONY_EXPERIMENT.setShowParents(True)
samp_type_SONY_EXPERIMENT.setSubcodeUnique(False)
samp_type_SONY_EXPERIMENT.setAutoGeneratedCode(False)
samp_type_SONY_EXPERIMENT.setShowParentMetadata(False)
samp_type_SONY_EXPERIMENT.setGeneratedCodePrefix('SONY_EXPERIMENT.')

# SONY_SPECIMEN
samp_type_SONY_SPECIMEN = tr.getOrCreateNewSampleType('SONY_SPECIMEN')
samp_type_SONY_SPECIMEN.setDescription('A specimen for the SONY Cell Sorters.')
samp_type_SONY_SPECIMEN.setListable(True)
samp_type_SONY_SPECIMEN.setShowContainer(False)
samp_type_SONY_SPECIMEN.setShowParents(True)
samp_type_SONY_SPECIMEN.setSubcodeUnique(False)
samp_type_SONY_SPECIMEN.setAutoGeneratedCode(True)
samp_type_SONY_SPECIMEN.setShowParentMetadata(False)
samp_type_SONY_SPECIMEN.setGeneratedCodePrefix('SONY_SPECIMEN.')

# SONY_TUBE
samp_type_SONY_TUBE = tr.getOrCreateNewSampleType('SONY_TUBE')
samp_type_SONY_TUBE.setDescription('A tube for the SONY Cell Sorters.')
samp_type_SONY_TUBE.setListable(True)
samp_type_SONY_TUBE.setShowContainer(False)
samp_type_SONY_TUBE.setShowParents(True)
samp_type_SONY_TUBE.setSubcodeUnique(False)
samp_type_SONY_TUBE.setAutoGeneratedCode(True)
samp_type_SONY_TUBE.setShowParentMetadata(False)
samp_type_SONY_TUBE.setGeneratedCodePrefix('SONY_TUBE.')

# SONY_TUBESET
samp_type_SONY_TUBESET = tr.getOrCreateNewSampleType('SONY_TUBESET')
samp_type_SONY_TUBESET.setDescription('A virtual container for tubes for the SONY Cell Sorters.')
samp_type_SONY_TUBESET.setListable(False)
samp_type_SONY_TUBESET.setShowContainer(False)
samp_type_SONY_TUBESET.setShowParents(True)
samp_type_SONY_TUBESET.setSubcodeUnique(False)
samp_type_SONY_TUBESET.setAutoGeneratedCode(True)
samp_type_SONY_TUBESET.setShowParentMetadata(False)
samp_type_SONY_TUBESET.setGeneratedCodePrefix('SONY_TUBESET.')
...
# SONY_FCSFILE
data_set_type_SONY_FCSFILE = tr.getOrCreateNewDataSetType('SONY_FCSFILE')
data_set_type_SONY_FCSFILE.setDescription('An FCS file from the SONY Cell Sorters.')
data_set_type_SONY_FCSFILE.setMainDataSetPattern('.*\.fcs')
data_set_type_SONY_FCSFILE.setMainDataSetPath(None)
data_set_type_SONY_FCSFILE.setDeletionDisallowed(False)
...
prop_type_LSR_FORTESSA_EXPERIMENT_ACQ_SOFTWARE = tr.getOrCreateNewPropertyType('LSR_FORTESSA_EXPERIMENT_ACQ_SOFTWARE', sDataType.VARCHAR)
...
# SONY_EXPERIMENT_ACQ_HARDWARE
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_ACQ_HARDWARE', DataType.VARCHAR)
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE.setLabel('Acquisition hardware')
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE.setInternalNamespace(False)

# SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME', DataType.VARCHAR)
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setLabel('Acquisition station name')
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setInternalNamespace(False)

# SONY_EXPERIMENT_ACQ_SOFTWARE
prop_type_SONY_EXPERIMENT_ACQ_SOFTWARE = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_ACQ_SOFTWARE', DataType.VARCHAR)
prop_type_SONY_EXPERIMENT_ACQ_SOFTWARE.setLabel('Acquisition software')
prop_type_SONY_EXPERIMENT_ACQ_SOFTWARE.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_ACQ_SOFTWARE.setInternalNamespace(False)

# SONY_EXPERIMENT_DATE
prop_type_SONY_EXPERIMENT_DATE = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_DATE', DataType.TIMESTAMP)
prop_type_SONY_EXPERIMENT_DATE.setLabel('Experiment date')
prop_type_SONY_EXPERIMENT_DATE.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_DATE.setInternalNamespace(False)

# SONY_EXPERIMENT_DESCRIPTION
prop_type_SONY_EXPERIMENT_DESCRIPTION = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_DESCRIPTION', DataType.MULTILINE_VARCHAR)
prop_type_SONY_EXPERIMENT_DESCRIPTION.setLabel('Description')
prop_type_SONY_EXPERIMENT_DESCRIPTION.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_DESCRIPTION.setInternalNamespace(False)

# SONY_EXPERIMENT_NAME
prop_type_SONY_EXPERIMENT_NAME = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_NAME', DataType.VARCHAR)
prop_type_SONY_EXPERIMENT_NAME.setLabel('Experiment name')
prop_type_SONY_EXPERIMENT_NAME.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_NAME.setInternalNamespace(False)

# SONY_EXPERIMENT_OWNER
prop_type_SONY_EXPERIMENT_OWNER = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_OWNER', DataType.VARCHAR)
prop_type_SONY_EXPERIMENT_OWNER.setLabel('Owner')
prop_type_SONY_EXPERIMENT_OWNER.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_OWNER.setInternalNamespace(False)

# SONY_EXPERIMENT_VERSION
prop_type_SONY_EXPERIMENT_VERSION = tr.getOrCreateNewPropertyType('SONY_EXPERIMENT_VERSION', DataType.INTEGER)
prop_type_SONY_EXPERIMENT_VERSION.setLabel('Version')
prop_type_SONY_EXPERIMENT_VERSION.setManagedInternally(False)
prop_type_SONY_EXPERIMENT_VERSION.setInternalNamespace(False)

# SONY_FCSFILE_ACQ_DATE
prop_type_SONY_FCSFILE_ACQ_DATE = tr.getOrCreateNewPropertyType('SONY_FCSFILE_ACQ_DATE', DataType.TIMESTAMP)
prop_type_SONY_FCSFILE_ACQ_DATE.setLabel('Acquisition date')
prop_type_SONY_FCSFILE_ACQ_DATE.setManagedInternally(False)
prop_type_SONY_FCSFILE_ACQ_DATE.setInternalNamespace(False)

# SONY_FCSFILE_PARAMETERS
prop_type_SONY_FCSFILE_PARAMETERS = tr.getOrCreateNewPropertyType('SONY_FCSFILE_PARAMETERS', DataType.MULTILINE_VARCHAR)
prop_type_SONY_FCSFILE_PARAMETERS.setLabel('FCS parameters')
prop_type_SONY_FCSFILE_PARAMETERS.setManagedInternally(False)
prop_type_SONY_FCSFILE_PARAMETERS.setInternalNamespace(False)

# SONY_TUBE_ISINDEXSORT
prop_type_SONY_TUBE_ISINDEXSORT = tr.getOrCreateNewPropertyType('SONY_TUBE_ISINDEXSORT', DataType.BOOLEAN)
prop_type_SONY_TUBE_ISINDEXSORT.setLabel('Index sort')
prop_type_SONY_TUBE_ISINDEXSORT.setManagedInternally(False)
prop_type_SONY_TUBE_ISINDEXSORT.setInternalNamespace(False)
...
# SAMPLE_SONY_EXPERIMENT_NAME
assignment_SAMPLE_SONY_EXPERIMENT_NAME = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_NAME)
assignment_SAMPLE_SONY_EXPERIMENT_NAME.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_NAME.setSection('General Info')
assignment_SAMPLE_SONY_EXPERIMENT_NAME.setPositionInForms(1)
assignment_SAMPLE_SONY_EXPERIMENT_NAME.setShownEdit(True)

# SAMPLE_SONY_EXPERIMENT_ANNOTATIONS_STATE
assignment_SAMPLE_SONY_EXPERIMENT_ANNOTATIONS_STATE = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_ANNOTATIONS_STATE)
assignment_SAMPLE_SONY_EXPERIMENT_ANNOTATIONS_STATE.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_ANNOTATIONS_STATE.setSection('General Info')
assignment_SAMPLE_SONY_EXPERIMENT_ANNOTATIONS_STATE.setPositionInForms(2)
assignment_SAMPLE_SONY_EXPERIMENT_ANNOTATIONS_STATE.setShownEdit(False)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DESCRIPTION
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DESCRIPTION = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_DESCRIPTION)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DESCRIPTION.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DESCRIPTION.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DESCRIPTION.setPositionInForms(3)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DESCRIPTION.setShownEdit(True)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_NAME
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_NAME = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_NAME)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_NAME.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_NAME.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_NAME.setPositionInForms(4)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_NAME.setShownEdit(False)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DATE
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DATE = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_DATE)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DATE.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DATE.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DATE.setPositionInForms(5)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_DATE.setShownEdit(True)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_ACQ_HARDWARE)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE.setPositionInForms(6)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE.setShownEdit(False)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_SOFTWARE
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_SOFTWARE = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_ACQ_SOFTWARE)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_SOFTWARE.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_SOFTWARE.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_SOFTWARE.setPositionInForms(7)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_SOFTWARE.setShownEdit(False)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_OWNER
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_OWNER = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_OWNER)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_OWNER.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_OWNER.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_OWNER.setPositionInForms(8)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_OWNER.setShownEdit(True)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setPositionInForms(9)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_ACQ_HARDWARE_FRIENDLY_NAME.setShownEdit(True)

# SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_VERSION
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_VERSION = tr.assignPropertyType(samp_type_SONY_EXPERIMENT, prop_type_SONY_EXPERIMENT_VERSION)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_VERSION.setMandatory(False)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_VERSION.setSection(None)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_VERSION.setPositionInForms(10)
assignment_SAMPLE_SONY_EXPERIMENT_SONY_EXPERIMENT_VERSION.setShownEdit(False)

# DATA_SET_SONY_FCSFILE_SONY_FCSFILE_PARAMETERS
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_PARAMETERS = tr.assignPropertyType(data_set_type_SONY_FCSFILE, prop_type_SONY_FCSFILE_PARAMETERS)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_PARAMETERS.setMandatory(False)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_PARAMETERS.setSection(None)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_PARAMETERS.setPositionInForms(2)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_PARAMETERS.setShownEdit(False)

# DATA_SET_SONY_FCSFILE_SONY_FCSFILE_ACQ_DATE
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_ACQ_DATE = tr.assignPropertyType(data_set_type_SONY_FCSFILE, prop_type_SONY_FCSFILE_ACQ_DATE)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_ACQ_DATE.setMandatory(False)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_ACQ_DATE.setSection(None)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_ACQ_DATE.setPositionInForms(3)
assignment_DATA_SET_SONY_FCSFILE_SONY_FCSFILE_ACQ_DATE.setShownEdit(False)

# DATA_SET_SONY_FCSFILE_NAME
assignment_DATA_SET_NFLUX_FCSFILE_NAME = tr.assignPropertyType(data_set_type_SONY_FCSFILE, prop_type_NAME)
assignment_DATA_SET_NFLUX_FCSFILE_NAME.setMandatory(False)
assignment_DATA_SET_NFLUX_FCSFILE_NAME.setSection(None)
assignment_DATA_SET_NFLUX_FCSFILE_NAME.setPositionInForms(3)
assignment_DATA_SET_NFLUX_FCSFILE_NAME.setShownEdit(False)

# SAMPLE_SONY_SPECIMEN_NAME
assignment_SAMPLE_SONY_SPECIMEN_NAME = tr.assignPropertyType(samp_type_SONY_SPECIMEN, prop_type_NAME)
assignment_SAMPLE_SONY_SPECIMEN_NAME.setMandatory(False)
assignment_SAMPLE_SONY_SPECIMEN_NAME.setSection('General Info')
assignment_SAMPLE_SONY_SPECIMEN_NAME.setPositionInForms(1)
assignment_SAMPLE_SONY_SPECIMEN_NAME.setShownEdit(True)

# SAMPLE_SONY_SPECIMEN_ANNOTATIONS_STATE
assignment_SAMPLE_SONY_SPECIMEN_ANNOTATIONS_STATE = tr.assignPropertyType(samp_type_SONY_SPECIMEN, prop_type_ANNOTATIONS_STATE)
assignment_SAMPLE_SONY_SPECIMEN_ANNOTATIONS_STATE.setMandatory(False)
assignment_SAMPLE_SONY_SPECIMEN_ANNOTATIONS_STATE.setSection('General Info')
assignment_SAMPLE_SONY_SPECIMEN_ANNOTATIONS_STATE.setPositionInForms(2)
assignment_SAMPLE_SONY_SPECIMEN_ANNOTATIONS_STATE.setShownEdit(False)

# SAMPLE_SONY_TUBE_NAME
assignment_SAMPLE_SONY_TUBE_NAME = tr.assignPropertyType(samp_type_SONY_TUBE, prop_type_NAME)
assignment_SAMPLE_SONY_TUBE_NAME.setMandatory(False)
assignment_SAMPLE_SONY_TUBE_NAME.setSection('General Info')
assignment_SAMPLE_SONY_TUBE_NAME.setPositionInForms(1)
assignment_SAMPLE_SONY_TUBE_NAME.setShownEdit(True)

# SAMPLE_SONY_TUBE_SONY_TUBE_ISINDEXSORT
assignment_SAMPLE_SONY_TUBE_SONY_TUBE_ISINDEXSORT = tr.assignPropertyType(samp_type_SONY_TUBE, prop_type_SONY_TUBE_ISINDEXSORT)
assignment_SAMPLE_SONY_TUBE_SONY_TUBE_ISINDEXSORT.setMandatory(False)
assignment_SAMPLE_SONY_TUBE_SONY_TUBE_ISINDEXSORT.setSection(None)
assignment_SAMPLE_SONY_TUBE_SONY_TUBE_ISINDEXSORT.setPositionInForms(4)
assignment_SAMPLE_SONY_TUBE_SONY_TUBE_ISINDEXSORT.setShownEdit(False)
